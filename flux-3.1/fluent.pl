...
eq(_229863, _229866, _229869) :- functor(_229863, _229881, _229884), functor(_229866, _229896, _229899), (_229881 = _229896, _229884 = _229899 -> _229863 =.. [_229922|_229924], _229866 =.. [_229931|_229933], and_eq(_229924, _229933, _229869) ; _229869 = (0 #\= 0)).
neq(_230365, _230368) :- or_neq(exists, _230365, _230368).
neq(_230397, _230400, _230403) :- or_neq_c(exists, _230397, _230400, _230403).
neq_all(_230436, _230439) :- or_neq(forall, _230436, _230439).
neq_all(_230468, _230471, _230474) :- or_neq_c(forall, _230468, _230471, _230474).
or_neq(_230507, _230510, _230513) :- functor(_230510, _230525, _230528), functor(_230513, _230540, _230543), (_230525 = _230540, _230528 = _230543 -> _230510 =.. [_230566|_230568], _230513 =.. [_230575|_230577], or_neq(_230507, _230568, _230577, _230589), call(_230589) ; true).
or_neq_c(_231011, _231014, _231017, _231020) :- functor(_231014, _231033, _231036), functor(_231017, _231048, _231051), (_231033 = _231048, _231036 = _231051 -> _231014 =.. [_231074|_231076], _231017 =.. [_231083|_231085], or_neq(_231011, _231076, _231085, _231020) ; _231020 = (0 #= 0)).
or_neq(_231544, [], [], 0 #\= 0).
or_neq(_231627, [_231632|_231633], [_231638|_231639], _231642) :- or_neq(_231627, _231633, _231639, _231659), (_231627 = forall, var(_231632), \+ is_domain(_231632) -> (binding(_231632, _231633, _231639, _231698) -> _231642 = #\/(_231638 #\= _231698, _231659) ; _231642 = _231659) ; _231642 = #\/(_231632 #\= _231638, _231659)).
binding(_232205, [_232210|_232211], [_232216|_232217], _232220) :- _232205 == _232210 -> _232220 = _232216 ; binding(_232205, _232211, _232217, _232220).
and_eq([], [], 0 #= 0).
and_eq([_232351|_232352], [_232357|_232358], _232361) :- and_eq(_232352, _232358, _232375), _232361 = #/\(_232351 #= _232357, _232375).
or_and_eq([], 0 #\= 0).
or_and_eq([_232655|_232656], #\/(_232659, _232663)) :- (_232655 = eq(_232675, _232678) -> and_eq(_232675, _232678, _232659) ; _232655 = neq(_232675, _232678), or_neq(exists, _232675, _232678, _232659)), or_and_eq(_232656, _232663).
inst(_233044, _233047) :- \+ (term_variables(_233044, _233060), term_variables(_233047, _233071), bound_free(_233071, _233060, _233084, _233087), copy_term_vars(_233087, _233047, _233102), \+ no_global_bindings(_233044 = _233102, _233084)).
copy_fluent(_233398, _233401, _233404, _233407) :- term_variables(_233398, _233420), bound_free(_233420, [], _233439, _233435), copy_term_vars(_233435, [_233398, _233401], [_233404, _233407]).
bound_free([], _233719, _233719, []).
bound_free([_233743|_233744], _233747, _233750, _233753) :- bound_free(_233744, _233747, _233768, _233771), (is_domain(_233743) -> _233750 = [_233743|_233768], _233753 = _233771 ; _233750 = _233768, _233753 = [_233743|_233771]).
member(_234135, [_234135|_234140], _234140).
member(_234159, [_234164|_234165], [_234164|_234170]) :- member(_234159, _234165, _234170).
not_holds(A, B) :-
	'CHRgen_num'(C),
...
:- current_macro('CHRnot_holds_2' / 4, _248593, _248594, _248595) -> true ; define_macro('CHRnot_holds_2' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRnot_holds_all_2' / 4, _251928, _251929, _251930) -> true ; define_macro('CHRnot_holds_all_2' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRduplicate_free_1' / 4, _252725, _252726, _252727) -> true ; define_macro('CHRduplicate_free_1' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRor_holds_2' / 4, _256646, _256647, _256648) -> true ; define_macro('CHRor_holds_2' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRor_holds_3' / 4, _257587, _257588, _257589) -> true ; define_macro('CHRor_holds_3' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRall_holds_2' / 4, _258259, _258260, _258261) -> true ; define_macro('CHRall_holds_2' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRall_holds_3' / 4, _259563, _259564, _259565) -> true ; define_macro('CHRall_holds_3' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRall_not_holds_3' / 4, _263393, _263394, _263395) -> true ; define_macro('CHRall_not_holds_3' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRif_then_holds_3' / 4, _266447, _266448, _266449) -> true ; define_macro('CHRif_then_holds_3' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRif_then_or_holds_3' / 4, _271736, _271737, _271738) -> true ; define_macro('CHRif_then_or_holds_3' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRif_then_or_holds_4' / 4, _272698, _272699, _272700) -> true ; define_macro('CHRif_then_or_holds_4' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRcancel_2' / 4, _273632, _273633, _273634) -> true ; define_macro('CHRcancel_2' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRcancelled_2' / 4, _277283, _277284, _277285) -> true ; define_macro('CHRcancelled_2' / 4, tr_chr / 2, [write]).
