...
customer('<REDACTED>','<REDACTED>',aaa).
customer('<REDACTED>','<REDACTED>',aaa).

customer('<REDACTED>',address('<REDACTED>','<REDACTED>','<REDACTED>','<REDACTED>','<REDACTED>'),aaa).
customer('<REDACTED>',address(unknown,unknown,'<REDACTED>','<REDACTED>',unknown),aaa).
...
% good_customer(X) :- customer(X, '<REDACTED>', _).
...
order :-
    write('The order c'<REDACTED>'ot be filled now.').

check_customer(C) :-
    good_customer(C).
check_customer(C) :-
    write('We c'<REDACTED>'ot perform an order for this customer.'), nl, fail.
